...
import { ArrowRightLeft, Languages, Loader2, Settings, Upload, FileText, Download } from "lucide-react"
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
const MODELS = [
  ...
  { value: "gemini-1.5-pro-latest", label: "Gemini 1.5 Pro", provider: "Google" },
  { value: "gemini-1.5-flash-latest", label: "Gemini 1.5 Flash", provider: "Google" },
  { value: "llama-3.3-70b-versatile", label: "Llama 3.3 70B", provider: "Meta" },
  { value: "llama-3.1-70b-versatile", label: "Llama 3.1 70B", provider: "Meta" },
]
...
export default function TranslatorApp() {
  ...
  const handleDownloadTranslation = () => {
    ...
    a.download = `translated_${originalName.replace(extension, "")}_${targetLang}${extension}`
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <Tabs defaultValue="text" className="w-full">
        ...
        <TabsContent value="text">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter text in the source language and get instant translations</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-muted-foreground">{sourceText.length} characters</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-muted-foreground">{translatedText.length} characters</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-3 mt-6">
                ...
                <Button onClick={handleSwapLanguages} variant="outline" size="lg" disabled={isTranslating}>
        ...
        <TabsContent value="file">
          <Card>
            <CardHeader>
              <CardTitle>Translate File</CardTitle>
              <CardDescription>Upload markdown, MDX, or image files for translation</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select value={sourceLang} onValueChange={setSourceLang}>
                      <SelectTrigger id="file-source-lang">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        {LANGUAGES.map((lang) => (
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={targetLang} onValueChange={setTargetLang}>
                      <SelectTrigger id="file-target-lang">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        {LANGUAGES.map((lang) => (
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Supported formats: .md, .mdx, .txt, .jpg, .jpeg, .png, .gif, .webp
                  </p>
                  {selectedFile && (
                ...
                {translatedFileContent && (
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Button onClick={handleDownloadTranslation} variant="outline" size="sm">
